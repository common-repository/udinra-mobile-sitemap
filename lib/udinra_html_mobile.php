...
<div class="w3-card-4" style="width:100%;">
	<header class="w3-container w3-blue"><h1>Udinra Mobile Sitemap (Configuration)</h1></header>
    <form action="" method="post">
      <div class="w3-container">
		...
		<a href="http://wordpress.org/extend/plugins/udinra-mobile-sitemap/" class="w3-button w3-ripple w3-sand">Please rate this plugin on WordPress.org</a>
		<div class="w3-panel w3-pale-blue w3-leftbar w3-rightbar w3-border-blue">
			<h3>Free version will not work if using AMP plugin.Please use Pro version.<a href="https://udinra.com/downloads/mobile-sitemap-pro-wordpress-plugin">Pro Plugin link</a></h3>
		</div>		
	</div>
	</form>
	<div class="w3-container">
